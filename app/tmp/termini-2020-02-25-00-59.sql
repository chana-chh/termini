...
CREATE TABLE IF NOT EXISTS `komintenti` (
  ...
  `kategorija` enum('Muzika','Fotograf','Torta','Dekoracija','Kokteli','Slatki sto','Voćni sto','Trubači','Animator','Posebni zahtevi','Ostalo') NOT NULL,
  `korisnik_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dumping data for table termini.logovi: ~17 rows (approximately)
...
INSERT IGNORE INTO `stavke_menija` (`id`, `naziv`, `cena`, `kategorija`, `korisnik_id`, `created_at`) VALUES
...
INSERT IGNORE INTO `ugovor_meni` (`id`, `ugovor_id`, `meni_id`, `komada`, `popust`) VALUES
	(1, 1, 1, 150, 100.00);
