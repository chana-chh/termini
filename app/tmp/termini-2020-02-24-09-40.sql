...
CREATE TABLE IF NOT EXISTS `komintenti` (
  ...
  `korisnik_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `napomena` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping data for table termini.komintenti: ~2 rows (approximately)
DELETE FROM `komintenti`;
/*!40000 ALTER TABLE `komintenti` DISABLE KEYS */;
INSERT INTO `komintenti` (`id`, `naziv`, `kategorija`, `korisnik_id`, `created_at`, `napomena`) VALUES
...
-- Dumping data for table termini.logovi: ~12 rows (approximately)
DELETE FROM `logovi`;
...
INSERT INTO `meniji` (`id`, `naziv`, `stavke`, `cena`, `napomena`, `korisnik_id`, `created_at`) VALUES
	(1, 'Meni 1', '1', 2000.00, 'Napomena A', 1, '2020-02-24 08:43:22'),
	(2, 'Meni 2', '2', 3000.00, 'Napomena B', 1, '2020-02-24 08:43:22'),
	(3, 'Meni 3', '2', 4000.00, 'Luksuzni meni', 1, '2020-02-24 08:43:22');
...
INSERT INTO `stavke_menija` (`id`, `naziv`, `cena`, `kategorija`, `korisnik_id`, `created_at`) VALUES
	(1, 'Losos', 1000.00, 'Predjelo', 0, '2020-02-24 09:38:30'),
	(2, 'Pršuta', 2000.00, 'Predjelo', 0, '2020-02-24 09:38:30');
...
-- Dumping data for table termini.termini: ~1 rows (approximately)
DELETE FROM `termini`;
...
-- Dumping data for table termini.ugovori: ~1 rows (approximately)
DELETE FROM `ugovori`;
/*!40000 ALTER TABLE `ugovori` DISABLE KEYS */;
INSERT INTO `ugovori` (`id`, `termin_id`, `broj_ugovora`, `datum`, `broj_mesta`, `broj_stolova`, `broj_mesta_po_stolu`, `prezime`, `ime`, `telefon`, `email`, `fizicko_pravno`, `naziv_firme`, `mb_firme`, `pib_firme`, `mesto_firme`, `adresa_firme`, `banka_firme`, `racun_firme`, `iznos_menija`, `muzika_chk`, `muzika_kom`, `muzika_opis`, `muzika_iznos`, `fotograf_chk`, `fotograf_kom`, `fotograf_opis`, `fotograf_iznos`, `torta_chk`, `torta_kom`, `torta_opis`, `torta_iznos`, `dekoracija_chk`, `dekoracija_kom`, `dekoracija_opis`, `dekoracija_iznos`, `kokteli_chk`, `kokteli_kom`, `kokteli_opis`, `kokteli_iznos`, `slatki_sto_chk`, `slatki_sto_kom`, `slatki_sto_opis`, `slatki_sto_iznos`, `vocni_sto_chk`, `vocni_sto_kom`, `vocni_sto_opis`, `vocni_sto_iznos`, `animator_chk`, `animator_kom`, `animator_opis`, `animator_iznos`, `trubaci_chk`, `trubaci_kom`, `trubaci_opis`, `trubaci_iznos`, `posebni_zahtevi_kom`, `posebni_zahtevi`, `posebni_zahtevi_iznos`, `iznos_dodatno`, `napomena`, `korisnik_id`, `created_at`) VALUES
	(1, 9, '01/2020', '2020-02-24', 150, 15, 10, 'Petar', 'Petrović', '03444567', 'pera@ptt.us', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 150000.00, 0, NULL, NULL, 0.00, 0, NULL, NULL, 0.00, 0, NULL, NULL, 0.00, 0, NULL, NULL, 0.00, 0, NULL, NULL, 0.00, 0, NULL, NULL, 0.00, 0, NULL, NULL, 0.00, 0, NULL, NULL, 0.00, 0, NULL, NULL, 0.00, NULL, NULL, 0.00, 0.00, 'Prvi ugovor za testiranje', 1, '2020-02-24 09:13:39');
...
-- Dumping data for table termini.ugovor_meni: ~1 rows (approximately)
DELETE FROM `ugovor_meni`;
/*!40000 ALTER TABLE `ugovor_meni` DISABLE KEYS */;
INSERT INTO `ugovor_meni` (`id`, `ugovor_id`, `meni_id`, `komada`, `popust`) VALUES
	(1, 1, 1, 150, 100.00);
...
CREATE TABLE IF NOT EXISTS `ugovor_soba` (
  ...
  `komada` int(10) unsigned NOT NULL DEFAULT 0,
  `popust` decimal(15,2) NOT NULL DEFAULT 0.00,
  `opis` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
